...
|---------|--------|---------|
| 192.168.1.0/24 | PC1 LAN | PC1, R1 G0/0 |
| 192.168.12.0/30 | R1 ↔ R2 | R1 G0/1, R2 G0/0 |
| 192.168.23.0/30 | R2 ↔ R3 | R2 G0/1, R3 G0/0 |
| 192.168.3.0/24 | PC2 LAN | R3 G0/1, PC2 |
...
| R3 | G0/0 | 192.168.23.2/30 |
| R3 | G0/1 | 192.168.3.1/24 |
| PC1 | Fa0 | 192.168.1.10/24 — GW: 192.168.1.1 |
| PC2 | Fa0 | 192.168.3.10/24 — GW: 192.168.3.1 |
...
- **Next-hop vs network confusion** — initially mixing up interface IPs with destination networks. Static route logic drilled: destination = the network you're missing, next hop = your neighbor's IP on the shared link.
